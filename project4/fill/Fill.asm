...
M=D
 ...
 // 32 words in a row * 255 rows (0-255, 256 total bc 0-index)
 // 8160 represents the 8k(minus 32 bytes) of screen memory starting
 // from @16384. We will add this to that constant to create an endofscreen
 // variable for looping tests.
@8160
D=A
@SCREEN
D=D+A       // total value of 24576
